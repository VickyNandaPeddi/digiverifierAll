...
//   @Operation(summary = "Upload Conventional  Candidate Drug Information")
...
//    }
//
//   @Operation(summary = "Upload Conventional  Candidate Reference Information")
...
//    }
//
//   @Operation(summary = "Upload Conventional  Candidate Experience Information")
...
//    }
//
//   @Operation(summary = "Upload Conventional  Candidate Educational Information")
...
//    }
//
//   @Operation(summary = "Upload Conventional  Candidate Information")
...
//    }
//
//   @Operation(summary = "Upload Conventional  Candidate Address Information")
...
//    }
   ...
   @Operation(summary = "Get Upload Details Status And Count")
   ...
   @Operation(summary = "Get Candidate Code By Candidate Id")
   ...
   @Operation(summary = "Get Vendor Details Status And Count")
    @PostMapping(value = "/findConVendorStatusCount")
   ...
   @Operation(summary = "Get Vendor Total Count")
    @PostMapping(value = "/findConVendorTotalCount")
    public ResponseEntity<ServiceOutcome<DashboardDto>> findConVendorTotalCount(@RequestHeader("Authorization") String authorization, @RequestBody DashboardDto dashboardDto) {
        ServiceOutcome<DashboardDto> svcSearchResult = candidateService.findConVendorTotalCount(dashboardDto);
        return new ResponseEntity<ServiceOutcome<DashboardDto>>(svcSearchResult, HttpStatus.OK);
    }
}
